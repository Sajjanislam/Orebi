...
// ========================
const Product = ({LareText1, LareText2,LareText3,offer,className }) => {
  return (
    <div className=' w-[370px] group font-DM relative'>
        <div className="img w-full h-[370px] relative">
            <img className='w-full h-full object-cover' src={cr01} alt="cr01" />
        ...
        <div className="text pt-6 font-DM">
            <div className="price flex justify-between items-baseline mb-3">
                <h3 className='font-bold text-xl text-[#262626]'>Basic Crew Neck Tee</h3>
                <span className='text-base text-[#767676]'> $44.00 </span>
            </div>
            <div className="brand text-base text-[#767676]"> Black</div>
